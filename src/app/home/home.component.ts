...
export class HomeComponent implements OnInit {
  ...
  SeeYourAppointments() {
    ...
    // this.http.get('http://localhost/wordpress/wordpress/wp-json/custom-plugin/userbookingappointments',{headers, responseType: 'text' }).subscribe((data)=>{
    // console.log('this is a booking data', data)
    // this.obj = data
    // console.log('this sending data form click ====>',this.obj)
